...
def p_function(iteration,switch):
    ...
    p.LCpathway = 0 * V_d[8]        # Locus coeruleus pathway used for InputCase = 'ZhengData', 'ThalamicTrianglesZheng', 'ZhengFittedParams' [0:default]
