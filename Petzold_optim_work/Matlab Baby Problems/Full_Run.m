...
tic
[A,x0,list_of_inside,list_of_outside] = Generate_system(N_list,Inside_min,Inside_max,Outside_min,Outside_max,Num_connections,Max_population);
figure(1)
spy(A)
...
disp('-')
disp(['N of Sobol: ', num2str(sum(N_Sobol))])
disp(['Sum of Sobol: ', num2str(sum(S))])
disp(['Min of Sobol: ', num2str(min(S))])
disp(['Min of Total Sobol: ', num2str(min(ST))])
disp('-----------------------------')
