...
# Neuron
    ...
    du[idx['I_k']] =  V_d[14]*(p.r_h * a.G) - p.k_deg * v.I_k
    ...
    du[idx['H_i']] = p.HETswitch_20HETE*(a.f_NO * p.V_a * v.AA_i /(p.K_a + v.AA_i) +  V_d[57]*(p.V_f * v.AA_i / (p.K_f + v.AA_i)) - V_d[58]*(p.lambda_h * v.H_i ))
